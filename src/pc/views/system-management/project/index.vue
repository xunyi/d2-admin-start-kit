<template>
  <d2-container>
    ...
    <div class="filter-area">
      <el-row type="flex" justify="space-between">
        <el-col :span="12">
          <el-row :gutter="20">
            <el-col :span="8">
              <el-select v-model="departmentValue" filterable placeholder="全部类型">
                <el-option
        ...
        <el-col class="right-btn" :span="8">
          <el-button type="primary">考评规则</el-button>
    ...
    <div class="data-area">
      ...
      <el-pagination class="custom-pagination" background layout="prev, pager, next" :total="1000"></el-pagination>
    </div>
